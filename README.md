...
07-09-2023 Finished the section on basic programming (for now, at least. So much more that one could write, but there are no end of resources out there that can cover all that!). The book is now complete enough for me to use in teaching this semester, I think. The danger, of course, it that I just stop now, but I'm so close to done with the first draft now, that I really hope I can push through and finish it up sooner rather than later!
